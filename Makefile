...
# coq_makefile -I . CompressionOpenProjections.v Compression.v Context.v DistinctList.v Examples.v FiniteTerm.v LemmaTest1.v LemmaTest2.v LemmaTest3.v Naturals.v OrdinalOld.v Ordinals2.v Ordinal.v OrdVector.v Prelims.v PreOrdinal.v RewritingOpenProjections.v RewritingOrdinalSequence.v RewritingOrdVector.v Rewriting.v SetOrdinal.v Signature.v Substitution.v TermEquality.v Term.v Variables.v Vector2.v Vector.v -no-install 
#
...
VFILES:=CompressionOpenProjections.v\
  Compression.v\
  Context.v\
  DistinctList.v\
  Examples.v\
