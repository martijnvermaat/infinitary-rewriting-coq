...
# coq_makefile -no-install -I . ContextEquality.v Context.v DistinctList.v ExampleABA.v ExampleUNWO.v FiniteTerm.v Naturals.v OrdinalOld.v Ordinals2.v Ordinal.v Prelims.v PreOrdinal.v Rewriting.v SetOrdinal.v Signature.v Substitution.v TermEquality.v Term.v Variables.v Vector2.v Vector.v -o Makefile 
#
