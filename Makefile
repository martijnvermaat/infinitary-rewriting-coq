...
# coq_makefile -no-install Context.v Finite_term.v Naturals.v Notes.v Ordinals.v prelims.v Rewriting.v SetOrdinals.v Signature.v Substitution.v Term_equality.v Term.v TreeOrdinals.v Variables.v Vector2.v Vector.v 
#
