...
# coq_makefile Context.v Finite_term.v Naturals.v Notes.v Ordinals.v OrdinalsOld.v Rewriting.v SetOrdinals.v Signature.v Substitution.v Term.v Term_equality.v Variables.v Vector.v Vector2.v prelims.v -I . -no-install -o Makefile 
#
