...
# coq_makefile -I . CompressionOpenProjections.v Compression.v Context.v Finite_term.v Naturals.v Notes.v Ordinals2.v OrdinalsOld.v Ordinals.v OrdVector.v prelims.v PreOrdinals.v RewritingOpenProjections.v RewritingOrdVector.v Rewriting.v SetOrdinals.v Signature.v Substitution.v Term_equality.v Term.v Variables.v Vector2.v Vector.v -no-install 
#
