...
# coq_makefile -I . Compression.v Context.v Finite_term.v Naturals.v Notes.v Ordinals2.v OrdinalsOld.v Ordinals.v prelims.v PreOrdinals.v Rewriting.v SetOrdinals.v Signature.v Substitution.v Term_equality.v Term.v Variables.v Vector2.v Vector.v -no-install 
#
