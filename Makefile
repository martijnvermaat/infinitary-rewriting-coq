...
# coq_makefile -noinstall -o makefile Context.v Finite_term.v Naturals.v Ordinals.v Rewriting.v Signature.v Substitution.v Term.v Term_equality.v Variables.v Vector.v Vector2.v 
#
