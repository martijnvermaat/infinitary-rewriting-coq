...
# coq_makefile -no-install -I . ContextEquality.v Context.v ExampleABA.v FiniteTerm.v NoUniqueNormalFormsWOElaborated.v NoUniqueNormalFormsWO.v Ordinal.v Prelims.v Rewriting.v Signature.v Substitution.v TermEquality.v Term.v Variables.v Vector.v WfOrdinal.v -o Makefile 
#
