...
##   \VV/  #                                                               ##
##    //   #  Makefile automagically generated by coq_makefile V8.3-beta0  ##
#############################################################################
...
# coq_makefile -no-install -I . COQDOCLIBS=http://coq.inria.fr/stdlib/ ContextEquality.v Context.v ExampleABA.v FiniteTerm.v NoUniqueNormalFormsWOElaborated.v NoUniqueNormalFormsWO.v Ordinal.v Prelims.v Rewriting.v Signature.v Substitution.v TermEquality.v Term.v Variables.v Vector.v WfOrdinal.v -o Makefile 
#
...
all: $(VOFILES) COQDOCLIBS=http://coq.inria.fr/stdlib/
spec: $(VIFILES)
...
COQDOCLIBS=http://coq.inria.fr/stdlib/:
	cd COQDOCLIBS=http://coq.inria.fr/stdlib/ ; $(MAKE) all
...
.PHONY: all opt byte archclean clean install depend html COQDOCLIBS=http://coq.inria.fr/stdlib/
...
clean:
	...
	- rm -rf html
	(cd COQDOCLIBS=http://coq.inria.fr/stdlib/ ; $(MAKE) clean)

archclean:
	rm -f *.cmx *.o
	(cd COQDOCLIBS=http://coq.inria.fr/stdlib/ ; $(MAKE) archclean)
