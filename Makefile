...
# coq_makefile -no-install Compression.v CompressionCantor.v CompressionOpenProjections.v Context.v ContextEquality.v DistinctList.v ExampleABA.v ExampleUNWO.v FiniteTerm.v LemmaTest1.v LemmaTest2.v LemmaTest3.v Naturals.v OrdVector.v Ordinal.v OrdinalOld.v Ordinals2.v PreOrdinal.v Prelims.v Rewriting.v RewritingCantor.v RewritingOpenProjections.v RewritingOrdVector.v RewritingOrdinalSequence.v SetOrdinal.v Signature.v Substitution.v Term.v TermEquality.v Variables.v Vector.v Vector2.v -o Makefile
#
